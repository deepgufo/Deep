...
  // Gestiamo le videoUrl internamente per permettere il recupero da localStorage
...
            </div>
          ) : isLoading ? (
            <div className="text-center animate-fadeIn pt-10 h-[calc(100vh-6rem)] flex flex-col justify-between">
              <div className="flex flex-col items-center">
                <div className="relative w-48 h-48 mx-auto mb-8">
                  <div className="absolute inset-0 bg-yellow-400/20 rounded-[38px] blur-[50px] animate-pulse" />
                  <div className="relative flex items-center justify-center h-full bg-black/60 rounded-[32px] border-2 border-yellow-400/30 overflow-hidden shadow-2xl">
                      <img 
...
              <div className="pb-8 px-6 text-left">
                <p className="text-[10px] text-zinc-500 font-medium flex items-center gap-1.5 opacity-60">
