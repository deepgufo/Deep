...
export default function FeedPage() {
  ...
  return (
    <main className="fixed inset-0 bg-[#000000]">
      ...
      <div className="h-full overflow-y-auto snap-y snap-mandatory pt-[48px] pb-20" style={{ scrollSnapType: 'y mandatory' }}>
        {posts.length > 0 ? (
          posts.map((post) => (
            <div
              key={post.id}
              className="h-[calc(100vh-48px)] snap-start flex items-center justify-center"
            >
              <div className="relative w-full h-[calc(100vh-140px)] max-w-[390px] mx-auto flex flex-col bg-black">
